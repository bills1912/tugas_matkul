...
```{r}
fa_salespeople_rotated_pca_m3 <- fa(r = salespeople_dat, nfactors = 3, covar = T, fm = "pa", max.iter = 100, rotate = "varimax")
...
solve(delta) %*% t(fa_salespeople_rotated_pca_m3$loadings[, c(1:3)]) %*% solve(diag(fa_salespeople_rotated_pca_m3$uniquenesses)) %*% (z - mean(z))
```
...
- Tidak merotasi faktor
```{r}
#fa_pca_unrotated2 <- fa(r = air_pollution_v2, nfactors = 2, covar = T, fm = "pa", max.iter = 100, rotate = "none")

#print(fa_pca_unrotated2)
```

- Dengan merotasi faktor
```{r}
#fa_pca_rotated2 <- fa(r = air_pollution_v2, nfactors = 2, covar = T, fm = "pa", max.iter = 100, rotate = "varimax")

#print(fa_pca_rotated2)
```
